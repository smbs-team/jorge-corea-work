...
namespace PTASExportConnector.SDK
{
    ...
    public class DbService : IDbService
    {
        ...
        public DbService()
        {
            this.sqlConnectionString = Environment.GetEnvironmentVariable("SqlConnectionString");
            ...
            if (!this.sqlConnectionString.Contains(ConnectionStringPasswordSection, System.StringComparison.OrdinalIgnoreCase))
            {
