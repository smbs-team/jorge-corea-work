...
namespace CustomSearchesEFLibrary.Gis.Model
{
    public partial class Systemuser
    {
        public Systemuser()
        {
            ...
            MapRendererCreatedByNavigation = new HashSet<MapRenderer>();
            MapRendererLastModifiedByNavigation = new HashSet<MapRenderer>();
            UserMapCreatedByNavigation = new HashSet<UserMap>();
            UserMapLastModifiedByNavigation = new HashSet<UserMap>();
        }
        ...
        public virtual ICollection<MapRenderer> MapRendererCreatedByNavigation { get; set; }
        public virtual ICollection<MapRenderer> MapRendererLastModifiedByNavigation { get; set; }
        public virtual ICollection<UserMap> UserMapCreatedByNavigation { get; set; }
        public virtual ICollection<UserMap> UserMapLastModifiedByNavigation { get; set; }
    }
}
