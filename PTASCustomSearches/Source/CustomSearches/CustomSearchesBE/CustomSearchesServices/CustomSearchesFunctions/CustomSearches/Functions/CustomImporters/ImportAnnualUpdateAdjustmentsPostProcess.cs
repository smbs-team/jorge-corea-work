namespace CustomSearchesFunctions.CustomSearches.Functions.CustomImporters
{
    ...
    /// </summary>
    public class ImportAnnualUpdateAdjustmentsPostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the annual update adjustments post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportAnnualUpdateAdjustmentsPostProcess"/> class.
        /// </summary>
        ...
        public ImportAnnualUpdateAdjustmentsPostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportAnnualUpdateAdjustmentsPostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportAnnualUpdateAdjustmentsPostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportAnnualUpdateAdjustmentsPostProcessService service = new ImportAnnualUpdateAdjustmentsPostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        var id = await service.ImportAnnualUpdateAdjustmentsPostProcessAsync(datasetPostProcessData, dbContext);
