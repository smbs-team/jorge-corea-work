namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    /// </summary>
    public class DeleteCalculatedColumn
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCalculatedColumn"/> class.
        /// </summary>
        ...
        public DeleteCalculatedColumn(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("DeleteCalculatedColumn")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/DeleteCalculatedColumn/{datasetId}/{columnName}")] HttpRequest req, Guid datasetId, string columnName, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    IServiceContext serviceContext = await this.serviceContextFactory.CreateFromHttpRequestAsync(req, log);
                    DeleteCalculatedColumnService service = new DeleteCalculatedColumnService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        await service.DeleteCalculatedColumnAsync(datasetId, columnName, dbContext, log);
                        return new OkResult();
                    }
                },
                req,
