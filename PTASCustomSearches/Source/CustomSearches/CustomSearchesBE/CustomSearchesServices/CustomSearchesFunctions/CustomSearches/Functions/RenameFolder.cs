namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    public class RenameFolder
    {
        ...
        public RenameFolder(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/RenameFolder")] HttpRequest req, ILogger log)
        {
