namespace CustomSearchesFunctions.CustomSearches.Functions.Datasets
{
    ...
    public class CullDataset
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CullDataset"/> class.
        /// </summary>
        ...
        public CullDataset(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("CullDataset")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/CullDataset/{datasetId}")] HttpRequest req, Guid datasetId, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    IServiceContext serviceContext = await this.serviceContextFactory.CreateFromHttpRequestAsync(req, log);
                    CullDatasetService service = new CullDatasetService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        await service.CullDatasetAsync(datasetId, dbContext);
