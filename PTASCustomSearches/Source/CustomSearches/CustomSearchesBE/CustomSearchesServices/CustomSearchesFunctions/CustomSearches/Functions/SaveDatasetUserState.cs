namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    /// </summary>
    public class SaveDatasetUserState
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveDatasetUserState"/> class.
        /// </summary>
        ...
        public SaveDatasetUserState(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("SaveDatasetUserState")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/SaveDatasetUserState/{datasetId}")] HttpRequest req, Guid datasetId, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    SaveDatasetUserStateService service = new SaveDatasetUserStateService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        await service.SaveDatasetUserStateAsync(datasetId, body, dbContext);
                        return new OkResult();
                    }
                },
                req,
