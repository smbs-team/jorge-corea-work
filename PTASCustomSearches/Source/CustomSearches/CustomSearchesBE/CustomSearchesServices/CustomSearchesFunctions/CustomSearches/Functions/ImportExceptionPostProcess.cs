namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    /// </summary>
    public class ImportExceptionPostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the exception post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportExceptionPostProcess"/> class.
        /// </summary>
        ...
        public ImportExceptionPostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportExceptionPostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportExceptionPostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportExceptionPostProcessService service = new ImportExceptionPostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        var id = await service.ImportExceptionPostProcessAsync(datasetPostProcessData, dbContext);
