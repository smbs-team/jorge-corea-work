namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    /// </summary>
    public class GetDatasetColumnLookupValues
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDatasetColumnLookupValues"/> class.
        /// </summary>
        ...
        public GetDatasetColumnLookupValues(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("GetDatasetColumnLookupValues")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "API/CustomSearches/GetDatasetColumnLookupValues/{datasetId}/{columnName}")] HttpRequest req, Guid datasetId, string columnName, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    GetDatasetColumnLookupValuesService service = new GetDatasetColumnLookupValuesService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        GetUserCustomSearchDataResponse response = await service.GetDatasetColumnLookupValuesAsync(datasetId, usePostProcess, postProcessId, columnName, dbContext);
