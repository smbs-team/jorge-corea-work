namespace CustomSearchesFunctions.CustomSearches.Functions.CustomImporters
{
    ...
    public class DeleteLandModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteLandModel"/> class.
        /// </summary>
        ...
        public DeleteLandModel(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("DeleteLandModel")]
        public async Task<IActionResult> Run(
            [HttpTrigger(
                AuthorizationLevel.Anonymous,
                "post",
                Route = "API/CustomSearches/DeleteLandModel/{datasetId}")]
            HttpRequest req,
            Guid datasetId,
            ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    DeleteLandModelService service = new DeleteLandModelService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        await service.DeleteLandModelAsync(datasetId, dbContext, log);
