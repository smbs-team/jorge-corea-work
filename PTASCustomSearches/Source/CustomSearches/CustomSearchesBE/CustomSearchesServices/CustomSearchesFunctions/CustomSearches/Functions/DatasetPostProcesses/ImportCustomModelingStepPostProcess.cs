namespace CustomSearchesFunctions.CustomSearches.Functions.DatasetPostProcesses
{
    ...
    /// </summary>
    public class ImportCustomModelingStepPostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the custom modeling step post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportCustomModelingStepPostProcess"/> class.
        /// </summary>
        ...
        public ImportCustomModelingStepPostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportCustomModelingStepPostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportCustomModelingStepPostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportCustomModelingStepPostProcessService service = new ImportCustomModelingStepPostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        IdResult id = await service.ImportCustomModelingStepPostProcessAsync(datasetPostProcessData, dbContext);
