namespace CustomSearchesFunctions.CustomSearches.Functions.CustomImporters
{
    ...
    /// </summary>
    public class ImportNonWaterfrontSchedulePostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the non-waterfront schedule post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportNonWaterfrontSchedulePostProcess"/> class.
        /// </summary>
        ...
        public ImportNonWaterfrontSchedulePostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportNonWaterfrontSchedulePostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportNonWaterfrontSchedulePostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportNonWaterfrontSchedulePostProcessService service = new ImportNonWaterfrontSchedulePostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        var id = await service.ImportNonWaterfrontSchedulePostProcessAsync(datasetPostProcessData, "NewLandValue", dbContext);
