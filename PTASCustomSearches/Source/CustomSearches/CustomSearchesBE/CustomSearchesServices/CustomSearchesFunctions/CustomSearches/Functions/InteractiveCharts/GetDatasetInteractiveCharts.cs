namespace CustomSearchesFunctions.CustomSearches.Functions.InteractiveCharts
{
    ...
    /// </summary>
    public class GetDatasetInteractiveCharts
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDatasetInteractiveCharts"/> class.
        /// </summary>
        ...
        public GetDatasetInteractiveCharts(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        /// The user map.
        /// </returns>
        /// <response code="200" cref="GetDatasetInteractiveChartsResponse">The request succeeded.</response>
        /// <response code="400" cref="ErrorResultModel">Bad request.</response>
        /// <response code="404" cref="ErrorResultModel">Entity was not found.</response>
        [FunctionName("GetDatasetInteractiveCharts")]
        public async Task<IActionResult> Run(
            [HttpTrigger(
                AuthorizationLevel.Anonymous,
                "get",
                Route = "API/CustomSearches/GetDatasetInteractiveCharts/{datasetId}")]
            HttpRequest req,
            Guid datasetId,
            ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    GetDatasetInteractiveChartsService service = new GetDatasetInteractiveChartsService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        GetDatasetInteractiveChartsResponse response =
                            await service.GetDatasetInteractiveChartsAsync(datasetId, dbContext);
