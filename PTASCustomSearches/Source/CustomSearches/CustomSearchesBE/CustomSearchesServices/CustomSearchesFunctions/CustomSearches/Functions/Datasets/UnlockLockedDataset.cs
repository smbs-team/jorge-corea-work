namespace CustomSearchesFunctions.CustomSearches.Functions.Datasets
{
    ...
    /// </summary>
    public class UnlockLockedDataset
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnlockLockedDataset"/> class.
        /// </summary>
        ...
        public UnlockLockedDataset(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("UnlockLockedDataset")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/UnlockLockedDataset/{datasetId}")] HttpRequest req, Guid datasetId, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    IServiceContext serviceContext = await this.serviceContextFactory.CreateFromHttpRequestAsync(req, log);
                    var service = new UnlockLockedDatasetService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        await service.UnlockLockedDataset(datasetId, dbContext);
