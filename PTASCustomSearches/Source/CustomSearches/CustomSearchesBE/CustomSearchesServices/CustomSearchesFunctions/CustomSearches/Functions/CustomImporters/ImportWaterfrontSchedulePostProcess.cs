namespace CustomSearchesFunctions.CustomSearches.Functions.CustomImporters
{
    ...
    /// </summary>
    public class ImportWaterfrontSchedulePostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the waterfront schedule post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportWaterfrontSchedulePostProcess"/> class.
        /// </summary>
        ...
        public ImportWaterfrontSchedulePostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportWaterfrontSchedulePostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportWaterfrontSchedulePostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportWaterfrontSchedulePostProcessService service = new ImportWaterfrontSchedulePostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        var id = await service.ImportWaterfrontSchedulePostProcessAsync(datasetPostProcessData, "WaterfrontValue", dbContext);
