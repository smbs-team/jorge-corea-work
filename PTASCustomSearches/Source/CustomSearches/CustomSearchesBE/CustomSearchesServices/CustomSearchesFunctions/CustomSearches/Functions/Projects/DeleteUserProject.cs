namespace CustomSearchesFunctions.CustomSearches.Functions.Projects
{
    ...
    /// </summary>
    public class DeleteUserProject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteUserProject"/> class.
        /// </summary>
        ...
        public DeleteUserProject(IFactory<CustomSearchesDbContext> dbContextFactory, ICloudStorageProvider cloudStorageProvider, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("DeleteUserProject")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/DeleteUserProject/{projectId}")] HttpRequest req, int projectId, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    IServiceContext serviceContext = await this.serviceContextFactory.CreateFromHttpRequestAsync(req, log);
                    DeleteUserProjectService service = new DeleteUserProjectService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        ...
                        await service.DeleteUserProjectAsync(projectId, dbContext, blobContainer);
                        return new OkResult();
                    }
                },
                req,
