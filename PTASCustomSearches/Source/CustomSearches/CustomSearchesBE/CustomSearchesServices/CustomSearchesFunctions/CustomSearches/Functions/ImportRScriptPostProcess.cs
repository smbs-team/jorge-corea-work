namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    /// </summary>
    public class ImportRScriptPostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the RScript post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportRScriptPostProcess"/> class.
        /// </summary>
        ...
        public ImportRScriptPostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportRScriptPostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportRScriptPostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportRScriptPostProcessService service = new ImportRScriptPostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        IdResult id = await service.ImportRScriptPostProcessAsync(datasetPostProcessData, dbContext);
