namespace CustomSearchesFunctions.CustomSearches.Functions
{
    ...
    /// </summary>
    public class ImportFilterPostProcess
    {
        /// <summary>
        /// The request body error message.
        /// </summary>
        private const string RequestBodyErrorMessage = "Cannot deserialize the request body that contains the filter post process.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportFilterPostProcess"/> class.
        /// </summary>
        ...
        public ImportFilterPostProcess(IFactory<CustomSearchesDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        [FunctionName("ImportFilterPostProcess")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ImportFilterPostProcess")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    ImportFilterPostProcessService service = new ImportFilterPostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        IdResult id = await service.ImportFilterPostProcessAsync(datasetPostProcessData, dbContext);
