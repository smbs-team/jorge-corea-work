namespace CustomSearchesFunctions.CustomSearches.Functions.DatasetPostProcesses
{
    ...
    /// </summary>
    public class ExecutePostProcessWithDataStream
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExecutePostProcessWithDataStream" /> class.
        /// </summary>
        ...
        public ExecutePostProcessWithDataStream(
        ...
        [FunctionName("ExecutePostProcessWithDataStream")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/CustomSearches/ExecutePostProcessWithDataStream/{datasetId}/{datasetPostProcessId}")] HttpRequest req,
            Guid datasetId,
            ...
            ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    var service = new ExecuteDatasetPostProcessService(serviceContext);
                    using (CustomSearchesDbContext dbContext = this.dbContextFactory.Create())
                    {
                        var idResult = await service.QueueExecuteDatasetPostProcessAsync(datasetId, datasetPostProcessId, major: null, minor: null, parameters: null, req.Body, dbContext);
