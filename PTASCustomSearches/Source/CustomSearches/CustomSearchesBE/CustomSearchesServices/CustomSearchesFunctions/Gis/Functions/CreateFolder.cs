namespace CustomSearchesFunctions.Gis.Functions
{
    ...
    public class CreateFolder
    {
        ...
        public CreateFolder(IFactory<GisDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        /// <param name="postBody" cref="CreateFolderData" in="body">Custom search parameters.</param>
        /// <returns>
        /// The folder id.
        /// </returns>
        [FunctionName("CreateFolder")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "API/GIS/CreateFolder")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    ...
                    {
                        int folderId = await service.CreateFolder(dbContext, createFolderData);
