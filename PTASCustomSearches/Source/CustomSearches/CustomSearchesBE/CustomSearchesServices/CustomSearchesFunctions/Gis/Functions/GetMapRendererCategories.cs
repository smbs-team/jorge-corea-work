namespace CustomSearchesFunctions.Gis.Functions
{
    ...
    /// </summary>
    public class GetMapRendererCategories
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMapRendererCategories"/> class.
        /// </summary>
        ...
        public GetMapRendererCategories(IFactory<GisDbContext> dbContextFactory, IServiceContextFactory serviceContextFactory)
        {
        ...
        /// </returns>
        [FunctionName("GetMapRendererCategories")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "API/GIS/GetMapRendererCategories")] HttpRequest req, ILogger log)
        {
            return await CustomSearchesFunctionsExceptionHandler.GlobalExceptionHandler(
                async () =>
                {
                    IServiceContext serviceContext = await this.serviceContextFactory.CreateFromHttpRequestAsync(req, log);
                    GetMapRendererCategoriesService service = new GetMapRendererCategoriesService(serviceContext);
                    using (GisDbContext dbContext = this.dbContextFactory.Create())
                    {
                        GetMapRendererCategoriesResponse response = await service.GetMapRendererCategories(dbContext);
