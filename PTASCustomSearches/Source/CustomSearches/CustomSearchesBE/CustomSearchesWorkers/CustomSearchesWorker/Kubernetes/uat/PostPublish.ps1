...
Copy-Item "$($scriptPath)\..\..\app.settings.uat.json" -Destination "$($scriptPath)\..\..\bin\Release\netcoreapp3.1\publish\app.settings.json"
...
Write-Host "Copy the [CustomSearchesWorker.zip] file in the [Docker] folder and run the [DeployUat.ps1] script."