...
Copy-Item "$($scriptPath)\..\..\app.settings.sbox.json" -Destination "$($scriptPath)\..\..\bin\Release\netcoreapp3.1\publish\app.settings.json"
...
Write-Host "Copy the [CustomSearchesWorker.zip] file in the [Docker] folder and run the [DeploySandbox.ps1] script."