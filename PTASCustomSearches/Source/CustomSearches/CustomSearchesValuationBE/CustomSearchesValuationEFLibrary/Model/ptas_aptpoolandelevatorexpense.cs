...
{
    public partial class ptas_aptpoolandelevatorexpense
    {
        public Guid ptas_aptpoolandelevatorexpenseid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_assessmentyear { get; set; }
        public decimal? ptas_elevatorpercentexpense { get; set; }
        public int? ptas_maxnumberofunits { get; set; }
        public int? ptas_minnumberofunits { get; set; }
        public string ptas_name { get; set; }
        public decimal? ptas_poolpercentexpense { get; set; }
