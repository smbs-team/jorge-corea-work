...
{
    public partial class ptas_landvaluecalculation
    {
        public ptas_landvaluecalculation()
        {
            Inverse_ptas_masterlandcharacteristicid_valueNavigation = new HashSet<ptas_landvaluecalculation>();
        }
        ...
        public virtual ptas_landvaluecalculation _ptas_masterlandcharacteristicid_valueNavigation { get; set; }
        public virtual ptas_zoning _ptas_zoningtypeid_valueNavigation { get; set; }
        public virtual ICollection<ptas_landvaluecalculation> Inverse_ptas_masterlandcharacteristicid_valueNavigation { get; set; }
    }
}
