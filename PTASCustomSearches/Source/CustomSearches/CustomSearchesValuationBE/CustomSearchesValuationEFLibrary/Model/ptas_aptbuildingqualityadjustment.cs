...
{
    public partial class ptas_aptbuildingqualityadjustment
    {
        public Guid ptas_aptbuildingqualityadjustmentid { get; set; }
        ...
        public decimal? ptas_caprateadjustment { get; set; }
        public decimal? ptas_commercialcapratemultiplier { get; set; }
        public decimal? ptas_commercialgimmultiplier { get; set; }
        public decimal? ptas_commercialrentmultiplier { get; set; }
        public decimal? ptas_gimadjustment { get; set; }
        public string ptas_name { get; set; }
        public decimal? ptas_rentscoefficient { get; set; }
        public decimal? ptas_salescoefficient { get; set; }
