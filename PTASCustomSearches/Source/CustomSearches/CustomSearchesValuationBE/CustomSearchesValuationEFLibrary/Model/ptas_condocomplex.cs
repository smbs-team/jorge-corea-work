...
{
    public partial class ptas_condocomplex
    {
        public ptas_condocomplex()
        {
            Inverse_ptas_majorcondocomplexid_valueNavigation = new HashSet<ptas_condocomplex>();
            Inverse_ptas_masterprojectid_valueNavigation = new HashSet<ptas_condocomplex>();
            ...
            ptas_projectdock = new HashSet<ptas_projectdock>();
        ...
        public virtual ptas_zipcode _ptas_addr1_zipcode_valueNavigation { get; set; }
        public virtual ptas_parceldetail _ptas_associatedparcel2id_valueNavigation { get; set; }
        public virtual ptas_parceldetail _ptas_associatedparcel3id_valueNavigation { get; set; }
        public virtual ptas_parceldetail _ptas_associatedparcelid_valueNavigation { get; set; }
        public virtual ptas_contaminationproject _ptas_contaminationproject_valueNavigation { get; set; }
        public virtual ptas_economicunit _ptas_economicunitid_valueNavigation { get; set; }
        public virtual ptas_condocomplex _ptas_majorcondocomplexid_valueNavigation { get; set; }
        public virtual ptas_condocomplex _ptas_masterprojectid_valueNavigation { get; set; }
        public virtual ptas_parceldetail _ptas_parcelid_valueNavigation { get; set; }
        public virtual ptas_parkingdistrict _ptas_parkingdistrictid_valueNavigation { get; set; }
        public virtual ICollection<ptas_condocomplex> Inverse_ptas_majorcondocomplexid_valueNavigation { get; set; }
        public virtual ICollection<ptas_condocomplex> Inverse_ptas_masterprojectid_valueNavigation { get; set; }
        ...
        public virtual ICollection<ptas_projectdock> ptas_projectdock { get; set; }
