...
{
    public partial class ptas_salepriceadjustment
    {
        public Guid ptas_salepriceadjustmentid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public decimal? exchangerate { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_adjustmenttype { get; set; }
        ...
        public int? ptas_linenumber { get; set; }
        public string ptas_name { get; set; }
        public string ptas_otherdescription { get; set; }
        public decimal? ptas_price { get; set; }
        public decimal? ptas_price_base { get; set; }
