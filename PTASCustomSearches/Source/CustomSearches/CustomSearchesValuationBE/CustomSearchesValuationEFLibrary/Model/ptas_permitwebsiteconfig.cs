...
{
    public partial class ptas_permitwebsiteconfig
    {
        public ptas_permitwebsiteconfig()
        {
            ptas_jurisdiction = new HashSet<ptas_jurisdiction>();
        }

        public Guid ptas_permitwebsiteconfigid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public bool? ptas_buildurl { get; set; }
        public string ptas_name { get; set; }
        public string ptas_url { get; set; }
        ...
        public virtual ICollection<ptas_jurisdiction> ptas_jurisdiction { get; set; }
    }
}
