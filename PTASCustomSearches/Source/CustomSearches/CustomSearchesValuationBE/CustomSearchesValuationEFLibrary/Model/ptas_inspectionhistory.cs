...
{
    public partial class ptas_inspectionhistory
    {
        public Guid ptas_inspectionhistoryid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_assessmentyear { get; set; }
        public DateTimeOffset? ptas_inspectiondate { get; set; }
        public int? ptas_inspectionreason { get; set; }
        public string ptas_inspectiontype { get; set; }
        ...
        public Guid? _ptas_inspectedbyid_value { get; set; }
        public Guid? _ptas_parcelid_value { get; set; }
        public Guid? _ptas_unit_value { get; set; }
        ...
        public virtual systemuser _ptas_inspectedbyid_valueNavigation { get; set; }
        public virtual ptas_parceldetail _ptas_parcelid_valueNavigation { get; set; }
        public virtual ptas_condounit _ptas_unit_valueNavigation { get; set; }
    }
}
