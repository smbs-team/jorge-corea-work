...
{
    public partial class ptas_trendfactor
    {
        public Guid ptas_trendfactorid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_age { get; set; }
        public decimal? ptas_interestrate { get; set; }
        public string ptas_name { get; set; }
        public decimal? ptas_percentgoodfactor { get; set; }
        public int? ptas_trendtable { get; set; }
