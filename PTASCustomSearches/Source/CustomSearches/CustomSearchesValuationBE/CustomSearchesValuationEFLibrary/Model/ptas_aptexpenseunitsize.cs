...
{
    public partial class ptas_aptexpenseunitsize
    {
        public Guid ptas_aptexpenseunitsizeid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_assessmentyear { get; set; }
        public int? ptas_maxunitsize { get; set; }
        public int? ptas_minunitsize { get; set; }
        public string ptas_name { get; set; }
        public decimal? ptas_unitsizeexpense { get; set; }
