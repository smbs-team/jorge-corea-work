...
{
    public partial class ptas_apttrending
    {
        public Guid ptas_apttrendingid { get; set; }
        ...
        public decimal? ptas_rentcoefficient { get; set; }
        public decimal? ptas_salecoefficient { get; set; }
