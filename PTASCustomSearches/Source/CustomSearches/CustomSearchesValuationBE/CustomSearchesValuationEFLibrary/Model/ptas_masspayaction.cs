...
{
    public partial class ptas_masspayaction
    {
        public Guid ptas_masspayactionid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_clearmasspayerontaxaccount { get; set; }
        public int? ptas_deletemasspayaccumulatorrecords { get; set; }
