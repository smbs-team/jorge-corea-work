...
{
    public partial class ptas_apartmentregion
    {
        public ptas_apartmentregion()
        {
            ptas_apartmentsupergroup = new HashSet<ptas_apartmentsupergroup>();
        }

        public Guid ptas_apartmentregionid { get; set; }
        ...
        public virtual ICollection<ptas_apartmentsupergroup> ptas_apartmentsupergroup { get; set; }
    }
}
