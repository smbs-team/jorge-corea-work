...
{
    public partial class ptas_aptunittypeadjustment
    {
        public Guid ptas_aptunittypeadjustmentid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_apartmentunittype { get; set; }
        public decimal? ptas_apartmentunittyperentcoefficient { get; set; }
