...
{
    public partial class ptas_residentialappraiserteam
    {
        public ptas_residentialappraiserteam()
        {
            ptas_area = new HashSet<ptas_area>();
        }
        ...
        public virtual ICollection<ptas_area> ptas_area { get; set; }
    }
}
