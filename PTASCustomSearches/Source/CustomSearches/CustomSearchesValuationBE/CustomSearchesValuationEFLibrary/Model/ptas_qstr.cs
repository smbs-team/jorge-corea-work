...
{
    public partial class ptas_qstr
    {
        public ptas_qstr()
        {
        ...
        public Guid ptas_qstrid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public string ptas_name { get; set; }
        public int? ptas_quartersection { get; set; }
        public string ptas_range { get; set; }
        public string ptas_section { get; set; }
        public string ptas_township { get; set; }
