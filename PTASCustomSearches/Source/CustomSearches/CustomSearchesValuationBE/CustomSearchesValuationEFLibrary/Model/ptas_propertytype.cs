...
{
    public partial class ptas_propertytype
    {
        public ptas_propertytype()
        {
            ...
            ptas_task_ptas_convertpropertytypefromid_valueNavigation = new HashSet<ptas_task>();
            ptas_task_ptas_convertpropertytypetoid_valueNavigation = new HashSet<ptas_task>();
        }

        public Guid ptas_propertytypeid { get; set; }
        ...
        public virtual ICollection<ptas_task> ptas_task_ptas_convertpropertytypefromid_valueNavigation { get; set; }
        public virtual ICollection<ptas_task> ptas_task_ptas_convertpropertytypetoid_valueNavigation { get; set; }
    }
}
