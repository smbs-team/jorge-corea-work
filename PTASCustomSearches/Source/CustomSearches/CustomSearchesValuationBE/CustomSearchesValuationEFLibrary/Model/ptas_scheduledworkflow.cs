...
{
    public partial class ptas_scheduledworkflow
    {
        public Guid ptas_scheduledworkflowid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_daystocheck { get; set; }
        public DateTimeOffset? ptas_lastrun { get; set; }
        public string ptas_name { get; set; }
        public string ptas_schedule { get; set; }
        public string ptas_workflowactionname { get; set; }
