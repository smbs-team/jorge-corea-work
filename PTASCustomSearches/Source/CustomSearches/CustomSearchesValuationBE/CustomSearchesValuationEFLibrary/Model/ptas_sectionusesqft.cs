...
{
    public partial class ptas_sectionusesqft
    {
        public ptas_sectionusesqft()
        {
            Inverse_ptas_mastersectionusesqftid_valueNavigation = new HashSet<ptas_sectionusesqft>();
        }

        public Guid ptas_sectionusesqftid { get; set; }
        ...
        public int? ptas_totalsqft { get; set; }
        ...
        public Guid? _ptas_mastersectionusesqftid_value { get; set; }
        public Guid? _ptas_projectid_value { get; set; }
        public Guid? _ptas_sectionuse_value { get; set; }
        ...
        public virtual ptas_sectionusesqft _ptas_mastersectionusesqftid_valueNavigation { get; set; }
        public virtual ptas_condocomplex _ptas_projectid_valueNavigation { get; set; }
        public virtual ptas_buildingsectionuse _ptas_sectionuse_valueNavigation { get; set; }
        public virtual ICollection<ptas_sectionusesqft> Inverse_ptas_mastersectionusesqftid_valueNavigation { get; set; }
    }
}
