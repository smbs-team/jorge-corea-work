...
{
    public partial class ptas_unitbreakdown
    {
        public ptas_unitbreakdown()
        {
            Inverse_ptas_masterunitbreakdownid_valueNavigation = new HashSet<ptas_unitbreakdown>();
        }
        ...
        public virtual ptas_condounit _ptas_floatinghome_valueNavigation { get; set; }
        public virtual ptas_unitbreakdown _ptas_masterunitbreakdownid_valueNavigation { get; set; }
        public virtual ptas_unitbreakdowntype _ptas_unitbreakdowntypeid_valueNavigation { get; set; }
        public virtual ICollection<ptas_unitbreakdown> Inverse_ptas_masterunitbreakdownid_valueNavigation { get; set; }
    }
}
