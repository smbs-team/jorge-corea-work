...
{
    public partial class ptas_aptviewrankadjustment
    {
        public Guid ptas_aptviewrankadjustmentid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public int? ptas_assessmentyear { get; set; }
        public decimal? ptas_caprateviewadjustmentcoefficient { get; set; }
        public decimal? ptas_caprateviewadjustmentintercept { get; set; }
        public decimal? ptas_gimviewadjsutmentcoefficient { get; set; }
        public decimal? ptas_gimviewadjustmentintercept { get; set; }
