...
{
    public partial class ptas_arcreasoncode
    {
        public ptas_arcreasoncode()
        {
            ptas_assessmentrollcorrection = new HashSet<ptas_assessmentrollcorrection>();
        }

        public Guid ptas_arcreasoncodeid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public string ptas_name { get; set; }
        public string ptas_reasoncodedescription { get; set; }
