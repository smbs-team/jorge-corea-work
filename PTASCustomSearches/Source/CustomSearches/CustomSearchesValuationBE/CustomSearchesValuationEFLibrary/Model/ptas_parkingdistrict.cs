...
{
    public partial class ptas_parkingdistrict
    {
        public ptas_parkingdistrict()
        {
            ptas_condocomplex = new HashSet<ptas_condocomplex>();
        }

        public Guid ptas_parkingdistrictid { get; set; }
        ...
        public decimal? ptas_dailyrate { get; set; }
        public decimal? ptas_dailyrate_base { get; set; }
        public decimal? ptas_monthlyrate { get; set; }
        public decimal? ptas_monthlyrate_base { get; set; }
        public string ptas_name { get; set; }
        public int? ptas_occupancyrate { get; set; }
        public decimal? ptas_operatingexpenses { get; set; }
        public decimal? ptas_operatingexpenses_base { get; set; }
        public int? ptas_percentofmonthlystalls { get; set; }
