...
{
    public partial class ptas_accessorydetail
    {
        public ptas_accessorydetail()
        {
            Inverse_ptas_masteraccessoryid_valueNavigation = new HashSet<ptas_accessorydetail>();
        ...
        public virtual ptas_accessorydetail _ptas_masteraccessoryid_valueNavigation { get; set; }
        ...
        public virtual ICollection<ptas_accessorydetail> Inverse_ptas_masteraccessoryid_valueNavigation { get; set; }
