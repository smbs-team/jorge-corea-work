...
{
    public partial class ptas_country
    {
        public ptas_country()
        {
            ...
            ptas_stateorprovince = new HashSet<ptas_stateorprovince>();
            ptas_taxaccount = new HashSet<ptas_taxaccount>();
        }

        public Guid ptas_countryid { get; set; }
        public DateTimeOffset? createdon { get; set; }
        public int? importsequencenumber { get; set; }
        public DateTimeOffset? modifiedon { get; set; }
        public DateTimeOffset? overriddencreatedon { get; set; }
        public string ptas_abbreviation { get; set; }
        public string ptas_alpha2 { get; set; }
        public string ptas_name { get; set; }
        public string ptas_numericcode { get; set; }
        ...
        public virtual ICollection<ptas_stateorprovince> ptas_stateorprovince { get; set; }
