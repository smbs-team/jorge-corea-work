...
{
    public partial class ptas_specialtyarea
    {
        public ptas_specialtyarea()
        {
            ...
            ptas_specialtyneighborhood = new HashSet<ptas_specialtyneighborhood>();
        }

        public Guid ptas_specialtyareaid { get; set; }
        ...
        public Guid? _ptas_seniorappraiserid_value { get; set; }
        ...
        public virtual systemuser _ptas_seniorappraiserid_valueNavigation { get; set; }
        ...
        public virtual ICollection<ptas_specialtyneighborhood> ptas_specialtyneighborhood { get; set; }
    }
}
