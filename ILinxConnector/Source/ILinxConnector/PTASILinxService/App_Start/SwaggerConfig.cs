// <copyright file="SwaggerConfig.cs" company="King County">
        ...
        public static void Configure(HttpConfiguration config)
        {
            ...
            config
                .EnableSwagger(c =>
                {
                    ...
                    c.PrettyPrint();
                    c.IncludeXmlComments(string.Format(@"{0}\bin\PTASIlinxService.xml", System.AppDomain.CurrentDomain.BaseDirectory));
