...
namespace D2SSyncHelpers.Interfaces
{
    ...
    public interface IDataAccessLibrary
    {
        ...
        Task<List<TDataType>> LoadData<TDataType, TParams>(string sql, TParams parameters, ILogger log = null);
        ...
        Task<int> SaveData<TDataType>(string sql, TDataType parameters, ILogger log = null);
    }
}