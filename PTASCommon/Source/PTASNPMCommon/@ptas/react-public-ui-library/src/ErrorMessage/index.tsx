...
export type errorMessageState = {
  open: boolean;
  type?: "simple" | "errorDetails";
  onClickReport?: () => void;
  errorDesc?: React.ReactNode | string;
  errorHead?: React.ReactNode | string;
};
...
const SnackBar = (
  ...
  const handleReportError = () => props.onClickReport && props.onClickReport();
    ...
    return (
      <div className={classes.wrapContent}>
        <div
          className={clsx(
            classes.content,
            props.type === "errorDetails" && classes.errorInfoContent
          )}
        >
          <div
            className={clsx(
              classes.errorInfo,
              props.type === "simple" && classes.centeredItems
            )}
          >
            <span className={classes.message}>
              {props.errorHead && props.errorHead}
              {!props.errorHead && fm.problemHasOcurred}{" "}
  ...
  return (
    <MUISnackBar
      className={clsx(
        classes.root,
        props.type === "errorDetails" && classes.errorInfoRoot
      )}
  ...
  return (
    ...
    >
      ...
      <SnackBar
        ...
        type={errorMessageState?.type || "simple"}
        onClickReport={errorMessageState.onClickReport}
        errorDesc={errorMessageState.errorDesc}
        errorHead={errorMessageState.errorHead}
      />
    </ErrorMessageContext.Provider>
  );
};
