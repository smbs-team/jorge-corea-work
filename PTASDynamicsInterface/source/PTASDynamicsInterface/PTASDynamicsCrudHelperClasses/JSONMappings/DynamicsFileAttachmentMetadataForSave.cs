// <copyright file="DynamicsFileAttachmentMetadataForSave.cs" company="King County">
...
namespace PTASDynamicsCrudHelperClasses.JSONMappings
{
    ...
    /// <summary>
    /// JSON mapping of a FileAttachmentMetadata for save.
    /// </summary>
    public class DynamicsFileAttachmentMetadataForSave : IFileAttachmentMetadata
    {
        /// <inheritdoc/>
        ...
        [JsonConverter(typeof(StringLimiterConverter))]
        ...
        /// <inheritdoc/>
        [JsonProperty("ptas_seniorexemptionapplication@odata.bind", NullValueHandling = NullValueHandling.Ignore)]
        public string SeniorExemptionApplicationId { get; set; }

        /// <inheritdoc/>
        [JsonProperty("ptas_seniorexemptionapplicationdetail@odata.bind", NullValueHandling = NullValueHandling.Ignore)]
