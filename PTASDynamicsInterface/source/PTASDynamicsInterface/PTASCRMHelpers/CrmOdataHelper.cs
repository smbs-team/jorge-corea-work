...
namespace PTASCRMHelpers
{
    ...
    public class CrmOdataHelper
    {
        ...
        public CrmOdataHelper(string crmUri, string authUri, string clientId, string clientSecret, ITokenManager tokenManager)
        {
            this.crmUri = crmUri;
        ...
        /// <returns>A string with the responde.</returns>
        ...
        /// <summary>
        /// CrmWebApiFormattedNtoNPostRequest:It formats the get request for N to N relationshops.
        /// </summary>
        ...
        /// <summary>
        /// This method formats the querystring about the entity T, it filters by keystr.
        /// </summary>
        /// <typeparam name="T">The json class of the entity.</typeparam>
        /// <param name="queryStr">The query string.</param>
        /// <param name="entity">The entity.</param>
        ...
        private string GetTokenUsingClientIdSecret()
        {
            ...
            try
            {
                ...
                this.tokenManager?.SetToken(tokenResult.AccessToken, tokenResult.ExpiresOn.DateTime, tokenResult.ExpiresOn.UtcTicks);
