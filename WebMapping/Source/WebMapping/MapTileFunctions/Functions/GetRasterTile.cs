namespace PTASMapTileFunctions.Functions
{
    ...
    /// <summary>
    /// Azure function class that servers raster tiles.
    /// </summary>
    public class GetRasterTile : GetTileBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRasterTile" /> class.
        /// </summary>
        ...
        [FunctionName("GetRasterTile")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "rastertiles/{layerId}/{z}/{y}/{x}")] HttpRequest req,
            string layerId,
            int z,
            int y,
            int x,
            ...
            ExecutionContext context)
        {
            ...
            try
            {
                byte[] tileBytes = await tileProvider.GetTile(y, x, z, layerId);
                tileBytes = tileBytes ?? new byte[0];

                return new FileContentResult(tileBytes, GetRasterTile.PngContentType);
            }
