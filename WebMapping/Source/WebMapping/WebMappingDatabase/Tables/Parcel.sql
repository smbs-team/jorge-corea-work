...
/****** Object:  Index [gi_parcel_geometry_sidx]    Script Date: 9/4/2019 1:08:54 PM ******/
CREATE SPATIAL INDEX [gi_parcel_geometry_sidx] ON [gis].[parcel]
(
	[Shape]
) USING  GEOMETRY_GRID 
...
CREATE NONCLUSTERED INDEX [IDX_PIN] ON [gis].[parcel]
(
	[pin] ASC
