CREATE TABLE [gis].[PARCEL_STAGING](
	...
	[Shape] [geometry] NULL,
 CONSTRAINT [PK_PARCEL_STAGING] PRIMARY KEY CLUSTERED 
(
	[OBJECTID] ASC
...
/****** Object:  Index [gi_parcel_staging_geometry_sidx]     Script Date: 9/4/2019 1:08:54 PM ******/
CREATE SPATIAL INDEX [gi_parcel_staging_geometry_sidx] ON [gis].[parcel_staging]
(
	[Shape]
) USING  GEOMETRY_GRID 
...
CREATE NONCLUSTERED INDEX [IDX_PIN] ON [gis].[parcel_staging]
(
	[pin] ASC
