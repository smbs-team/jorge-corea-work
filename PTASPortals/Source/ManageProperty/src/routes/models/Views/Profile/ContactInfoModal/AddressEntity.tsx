  ...
  return (
    <Box className={classes.root}>
      <AddressInfoFields
        ...
        loadingAddressSuggestions={props.loadingAddressSuggestions}
        countryItems={props.countryItems}
        citySuggestions={props.citySuggestions}
        loadingCitySuggestions={props.loadingCitySuggestions}
        stateSuggestions={props.stateSuggestions}
        loadingStateSuggestions={props.loadingStateSuggestions}
        zipCodeSuggestions={props.zipCodeSuggestions}
        loadingZipCodeSuggestions={props.loadingZipCodeSuggestions}
