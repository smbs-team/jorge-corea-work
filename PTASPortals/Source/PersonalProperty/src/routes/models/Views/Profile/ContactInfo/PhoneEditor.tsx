...
export interface PhoneEditorTextProps extends PhoneInfoTextProps {
 ...
 * Component props
 */
interface Props extends WithStyles<typeof styles>, PhoneEditorTextProps {
  phone: PortalPhone;
 ...
 */
function PhoneEditor(props: Props): JSX.Element {
...
export default withStyles(styles)(PhoneEditor) as FC<GenericWithStyles<Props>>;
