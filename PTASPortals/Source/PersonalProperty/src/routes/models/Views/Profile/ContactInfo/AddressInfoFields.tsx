...
function AddressInfoFields(props: Props): JSX.Element {
  ...
  const onAddressSearchChange = (
    ...
    props.onAddressSearchChange && props.onAddressSearchChange(e.target.value);
  };
  ...
  const onCitySearchChange = (
    ...
    props.onCitySearchChange && props.onCitySearchChange(e.target.value);
  };
  ...
  const onStateSearchChange = (
    ...
    props.onStateSearchChange &&
      props.onStateSearchChange(e.target.value, address?.countryId ?? '');
  };

  const onZipCodeSearchChange = (
    e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
  ): void => {
    props.onZipCodeSearchChange && props.onZipCodeSearchChange(e.target.value);
  };
