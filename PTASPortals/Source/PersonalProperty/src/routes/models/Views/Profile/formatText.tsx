...
export const title2 = (
  <FormattedMessage id="profile_title2" defaultMessage="My profile" />
);

export const title3 = (
  <FormattedMessage id="profile_title3" defaultMessage="New person" />
);

export const back = (
  <FormattedMessage id="profile_back" defaultMessage="Back" />
);
...
export const tabPassword = (
  <FormattedMessage id="profile_tab_password" defaultMessage="Password" />
);

export const passwordReviewUpdate = (
  <FormattedMessage
    id="profile_password_review_update"
    defaultMessage="Review or update your password."
  />
);

export const passwordLabel = (
  <FormattedMessage id="profile_password_label" defaultMessage="Password" />
);
...
export const modalAddressTitle = (
  <FormattedMessage
...
export const modalAddressCountry = (
  <FormattedMessage
...
export const modalAddressCity = (
  <FormattedMessage id="profile_modal_address_city" defaultMessage="City" />
);

export const modalAddressState = (
  <FormattedMessage id="profile_modal_address_state" defaultMessage="State" />
);

export const modalAddressZip = (
...
export const tabAccess = (
  <FormattedMessage id="profile_tab_access" defaultMessage="Access" />
);

export const accessNotices = (
  <FormattedMessage
    id="profile_access_notices"
    defaultMessage="Notices are sent to anyone who has access to a client."
  />
);

export const accessParcel = (parcelNumber: string | number): JSX.Element => (
  <FormattedMessage
    id="profile_access_parcel"
    defaultMessage="Parcel #{parcelNumber}"
    values={{
      parcelNumber,
    }}
  />
...
export const accessNone = (
  <FormattedMessage id="profile_access_none" defaultMessage="None" />
);

export const accessView = (
  <FormattedMessage id="profile_access_view" defaultMessage="View" />
);

export const accessEdit = (
  <FormattedMessage id="profile_access_edit" defaultMessage="Edit" />
);
...
export const buttonRemoveAccount = (name: string): JSX.Element => (
  <FormattedMessage
    id="profile_button_remove_account"
    defaultMessage="Remove {name}'s account"
    values={{ name }}
  />
);

export const removeAccountAlert = (
  <FormattedMessage
    id="profile_remove_account_alert"
    defaultMessage="Permanently removes this person from your account and removes their access to your businesses."
  />
);

export const removeAccountAlertButton = (
  <FormattedMessage
    id="profile_remove_account_alert_button"
    defaultMessage="Remove"
  />
);
...
export const deleteContactError = (
  <FormattedMessage
    id="profile_delete_contact_error"
    defaultMessage="Error on delete contact"
  />
);
