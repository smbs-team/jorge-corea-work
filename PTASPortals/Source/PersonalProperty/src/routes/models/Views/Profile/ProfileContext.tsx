...
import usePrimaryProfile, { UsePrimaryProfile } from './usePrimaryProfile';
import useSecondaryProfile, {
  UseSecondaryProfile,
} from './useSecondaryProfile';

// eslint-disable-next-line @typescript-eslint/no-empty-interface
interface ProfileContextProps extends UsePrimaryProfile, UseSecondaryProfile {}
...
const ProfileProvider = ({ children }: PropsWithChildren<{}>): JSX.Element => {
  return (
    <ProfileContext.Provider
      value={{ ...usePrimaryProfile(), ...useSecondaryProfile() }}
    >
      {children}
    </ProfileContext.Provider>
  );
