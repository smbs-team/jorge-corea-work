/*
//-----------------------------------------------------------------------
// <copyright file="react-cropper.js" company="King County">
...
class ReactCropper extends Component {
  ...
  handleClickInside = e => {
    console.log('e.target.classList333', e.target.classList);
    console.log('e', e);
    console.log('e.target.classList333', e.target.classList[1]);
    console.log('isRedacting', this.props.isRedacting);
    console.log('isRedacting', this.props);

    if (e.target.classList[1] === 'point-ne' && this.props.isRedacting) {
      this.dismissAll();
    }
    if (e.target.classList[1] === 'point-s' && this.props.isCropping) {
      console.log('e.target.classList333 finishcrop', this.props);
