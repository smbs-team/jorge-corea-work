...
{
    public partial class PtasAptviewqualityadjustment
    {
        public Guid PtasAptviewqualityadjustmentid { get; set; }
        public DateTimeOffset? Createdon { get; set; }
        public int? Importsequencenumber { get; set; }
        public DateTimeOffset? Modifiedon { get; set; }
        public DateTimeOffset? Overriddencreatedon { get; set; }
        public int? PtasAptviewquality { get; set; }
        public int? PtasAssessmentyear { get; set; }
        public string PtasName { get; set; }
        public decimal? PtasViewqualityadjustment { get; set; }
