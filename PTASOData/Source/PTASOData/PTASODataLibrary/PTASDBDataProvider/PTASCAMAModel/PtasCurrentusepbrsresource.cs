...
{
    public partial class PtasCurrentusepbrsresource
    {
        public Guid PtasCurrentusepbrsresourceid { get; set; }
        public DateTimeOffset? Createdon { get; set; }
        public int? Importsequencenumber { get; set; }
        public DateTimeOffset? Modifiedon { get; set; }
        public DateTimeOffset? Overriddencreatedon { get; set; }
        public string PtasName { get; set; }
        public int? PtasPointvalue { get; set; }
        ...
        public Guid? PtasPbrsresourcetypeValue { get; set; }
        ...
        public virtual PtasPbrsresourcetype PtasPbrsresourcetypeValueNavigation { get; set; }
    }
}
