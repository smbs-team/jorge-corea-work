...
{
    public partial class PtasAptpoolandelevatorexpense
    {
        public Guid PtasAptpoolandelevatorexpenseid { get; set; }
        public DateTimeOffset? Createdon { get; set; }
        public int? Importsequencenumber { get; set; }
        public DateTimeOffset? Modifiedon { get; set; }
        public DateTimeOffset? Overriddencreatedon { get; set; }
        public int? PtasAssessmentyear { get; set; }
        public decimal? PtasElevatorpercentexpense { get; set; }
        public int? PtasMaxnumberofunits { get; set; }
        public int? PtasMinnumberofunits { get; set; }
        public string PtasName { get; set; }
        public decimal? PtasPoolpercentexpense { get; set; }
