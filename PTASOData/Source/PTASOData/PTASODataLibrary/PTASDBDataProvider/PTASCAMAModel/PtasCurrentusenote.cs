...
{
    public partial class PtasCurrentusenote
    {
        public Guid PtasCurrentusenoteid { get; set; }
        ...
        public string PtasNotebody { get; set; }
        public DateTimeOffset? PtasNotedate { get; set; }
