...
{
    public partial class PtasLandvaluecalculation
    {
        public PtasLandvaluecalculation()
        {
            InversePtasMasterlandcharacteristicidValueNavigation = new HashSet<PtasLandvaluecalculation>();
        }
        ...
        public virtual PtasDesignationtype PtasDesignationtypeidValueNavigation { get; set; }
        public virtual PtasEnvironmentalrestrictiontype PtasEnvrestypeidValueNavigation { get; set; }
        public virtual PtasLand PtasLandidValueNavigation { get; set; }
        public virtual PtasLandvaluecalculation PtasMasterlandcharacteristicidValueNavigation { get; set; }
        public virtual PtasNuisancetype PtasNuisancetypeidValueNavigation { get; set; }
        public virtual PtasViewtype PtasViewtypeidValueNavigation { get; set; }
        public virtual PtasZoning PtasZoningtypeidValueNavigation { get; set; }
        public virtual ICollection<PtasLandvaluecalculation> InversePtasMasterlandcharacteristicidValueNavigation { get; set; }
    }
}
