...
{
    public partial class PtasSalepriceadjustment
    {
        public Guid PtasSalepriceadjustmentid { get; set; }
        public DateTimeOffset? Createdon { get; set; }
        public decimal? Exchangerate { get; set; }
        public int? Importsequencenumber { get; set; }
        public DateTimeOffset? Modifiedon { get; set; }
        public DateTimeOffset? Overriddencreatedon { get; set; }
        public int? PtasAdjustmenttype { get; set; }
        ...
        public int? PtasLinenumber { get; set; }
        public string PtasName { get; set; }
        public string PtasOtherdescription { get; set; }
        public decimal? PtasPrice { get; set; }
        public decimal? PtasPriceBase { get; set; }
