...
{
    public partial class PtasTimberusetype
    {
        public PtasTimberusetype()
        {
            PtasCurrentuselanduse = new HashSet<PtasCurrentuselanduse>();
        }

        public Guid PtasTimberusetypeid { get; set; }
        ...
        public int? PtasTimberlandgrade { get; set; }
        public int? PtasTimberoperabilityclass { get; set; }
